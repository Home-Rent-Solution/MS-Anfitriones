...
public class AnfitrionesController {
    ...
    public ResponseEntity<AnfitrionesResponseDTO> getPorId(@Parameter(
    ...
    public ResponseEntity<AnfitrionesResponseDTO> postAnfitrion(@io
            .swagger
            .v3
            .oas
            .annotations
            ...
            return ResponseEntity
                    ...
                    .body(anfitrionesService.save(dto));
        }
    ...
    public ResponseEntity<AnfitrionesResponseDTO> putAnfitrion(
            ...
            @Valid @RequestBody AnfitrionesRequestDTO dto){
        return ResponseEntity.ok(anfitrionesService.editar(
                idAnfitrion,
                dto)
        );
    }
